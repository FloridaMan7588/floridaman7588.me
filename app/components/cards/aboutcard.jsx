export default function AboutCard({ about, skills }) {
	...
	return (
		<div className='bg-mantle rounded-[45px]'>
			<h1 className='text-text text-center text-4xl font-bold px-7 py-4'>About Me</h1>
			<div className='grid-cols-1 grid md:flex md:justify-center place-items-center px-4'>
				...
				<div className="py-8">
					<div className='text-text px-8 md:px-16 py-4 rounded-[45px] justify-center min-w-fit bg-crust'>
